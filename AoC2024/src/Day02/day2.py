...
print("Test:  ", count_safe_reports("test.txt"), safe_level)
print("Part 1:", count_safe_reports("input.txt"), safe_level)
...
print("Test:  ", count_safe_reports("test.txt", safe_dampener))
print("Part 2:", count_safe_reports("input.txt", safe_dampener))